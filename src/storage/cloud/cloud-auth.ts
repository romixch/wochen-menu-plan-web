...
const addOnLoginListener = (
  handler: (previousLoginEmail: string | null, nextLoginEmail: string | null) => Promise<void>
) => {
...
export type LoginState = 'logged in' | 'not logged in' | 'waiting for onetime token'
